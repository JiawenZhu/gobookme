...
export function listTeams(dcOrOptions, options) {
...
export const listBookingsRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
export function listBookings(dcOrOptions, options) {
...
export const getUserCredentialsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getUserCredentials(dcOrVars, varsOrOptions, options) {
