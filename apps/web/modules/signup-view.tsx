                ...
                <div className="-mt-4 mr-12 mb-6 grid w-full grid-cols-3 gap-5 pr-4 sm:gap-3 lg:grid-cols-4">
                  <div>
                    ...
                    <img
                      ...
                      alt="GoBookMe was Product of the Day at ProductHunt"
                    />
                  </div>
                  <div>
                    {/* eslint-disable @next/next/no-img-element */}
                    <img
                      ...
                      className="h-[34px] w-full dark:invert"
                      alt="GoBookMe was Product of the Week at ProductHunt"
                    />
                  </div>
                  <div>
                    {/* eslint-disable @next/next/no-img-element */}
                    <img
                      ...
                      className="h-[34px] w-full dark:invert"
                      alt="GoBookMe was Product of the Month at ProductHunt"
                    />
                  </div>
                </div>
