...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://gobookme.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "gobookme";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@gobookme.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "gobookme, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "gobookme";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "gobookme";
...
export const LOGO = "/gobookme-logo-light.svg";
export const LOGO_DARK = "/gobookme-logo-dark.svg";
export const LOGO_ICON = "/gobookme-icon.svg";
...
export const ROADMAP = "https://gobookme.com/roadmap";
export const DESKTOP_APP_LINK = "https://gobookme.com/download";
export const JOIN_COMMUNITY = "https://gobookme.com/community";
export const POWERED_BY_URL = "https://gobookme.com";
export const DOCS_URL = "https://gobookme.com/docs";
export const DEVELOPER_DOCS = "https://gobookme.com/developers";
...
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://gobookme.com/privacy";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://gobookme.com/terms";
